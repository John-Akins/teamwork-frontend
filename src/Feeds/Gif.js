...
const RESET_DATA = { title: "", id: "", createdOn: "", authorId: "", imageUrl: "", comments: [] }
...
class Gif extends Component {
    ...
    componentDidMount() {
        ...
        makeRequest("GET", `${this.props.api}gif/${this.props.match.params.gifId}`,{}, this.props.userSecrets)
        .then((response) => {
    ...
    render() {
        ...
        <Moment fromNow>{ this.state.feed.createdOn || today }</Moment>
            ...
            <li className="collection-item avatar feed-content">
                    <img src={this.state.feed.imageUrl} alt='content' />
                </li>     
